...
Section Exercices.
  ...
  Section About_cuts.
    ...
    Admitted. (* À remplacer par "Qed." une fois la preuve faite. *)
...
(* Les coupures deviennent des "let.. in.." similaires à ceux de Ocaml *)
 ...
 (* meme exercice avec 
  ...
  Hypothesis H1: P->R.
  Hypothesis H2: Q->R->T.
  Lemma distrib_impl_hypothesis:P->T .
  Proof.
    intro.
    apply H2.
    apply H.
  ...
  Hypothesis H3:(P->R)->T.
  Lemma proof_of_ex9_hypothesis: Q.
    Proof.
      apply H2.
      - intro.
        apply H1.
